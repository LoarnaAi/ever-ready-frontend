              ...
              <button
                ...
                style={
                  schedule.intervalType === "6hours" && schedule.timeSlot === slot
                    ? { ...styles.primaryButton, ...styles.primaryBorder }
                    : undefined
                }
              >
                {slot}
      ...
      <div className="w-full max-w-6xl mx-auto p-4 md:p-6">
        ...
        <div className="mb-6">
          ...
          <div className="w-full bg-gray-200 rounded-full h-2">
            <div className="h-2 rounded-full" style={{ ...styles.progressBar, width: "83.33%" }}></div>
          </div>
        </div>
            ...
            <div className="mb-3">
              ...
              <div className="w-full bg-gray-200 rounded-full h-1.5">
                <div
                  ...
                  style={{ ...styles.progressBar, width: "83.33%" }}
                ></div>
              </div>
            </div>
                    ...
                    <div className="space-y-2 pl-1">
                      ...
                      {collectionDate.date && (
                        <div className="space-y-1">
                          ...
                          <div className="text-xs text-gray-700 pl-2">
                            {formatDate(collectionDate.date)} - {collectionDate.timeSlot}
                          </div>
                        </div>
                      )}
                      {materialsDelivery.date && (
                        <div className="space-y-1">
                          ...
                          <div className="text-xs text-gray-700 pl-2">
                            {formatDate(materialsDelivery.date)} - {materialsDelivery.timeSlot}
                          </div>
                        </div>
                      )}
                      {!savedAddresses.collection?.postcode && !savedAddresses.delivery?.postcode && !collectionDate.date && !materialsDelivery.date && (
                        <div className="text-xs text-gray-500 text-center py-4 bg-gray-50 rounded-lg border border-gray-200">
                          <p>No move details</p>
                        </div>
                      )}
        ...
        <div className="flex flex-col md:flex-row gap-4 md:gap-6">
          ...
          <div className="hidden md:flex md:flex-col w-full md:w-80 lg:w-96 bg-white border border-gray-200 p-4 rounded-lg shadow-sm">
            ...
            <div className="mb-4 flex justify-center">
              <BusinessLogo variant="full" width={200} height={200} priority />
            </div>
          ...
          <div className="flex-1 bg-white rounded-lg shadow-sm p-3 sm:p-4 max-w-3xl overflow-y-auto max-h-[85vh] order-2 lg:order-2">
            ...
            <h2 className="text-base sm:text-lg font-bold text-gray-900 mb-1">
              ...
              <span className="block sm:inline" style={styles.primaryText}>
            ...
            <p className="text-base sm:text-lg text-gray-900 mb-4">
              between <span style={styles.primaryText}>{materialsDelivery.timeSlot}</span>.
            </p>
            ...
            <div className="mb-6">
              ...
              <p className="text-base sm:text-lg text-gray-900 mb-4">
                between <span style={styles.primaryText}>{collectionDate.timeSlot}</span>.
              </p>
