...
export default function BusinessHomeRemoval() {
  ...
  const serviceOptions = [
    { id: "1-bedroom", title: "1 Bedroom Home", bedrooms: 1 },
    { id: "2-bedrooms", title: "2 Bedroom Home", bedrooms: 2 },
    { id: "3-bedrooms", title: "3 Bedroom Home", bedrooms: 3 },
    { id: "4-bedrooms", title: "4 Bedroom Home", bedrooms: 4 },
  ];
  ...
  const handleStep6Previous = () => setCurrentStep(5);
  ...
  // Render step 1 (service selection) with themed colors
  return (
      ...
      <div className="w-full max-w-5xl mx-auto p-4 md:p-6">
        ...
        <div className="mb-6">
          ...
          <div className="w-full bg-gray-200 rounded-full h-2">
            <div className="h-2 rounded-full" style={{ ...primaryBgStyle, width: '16.66%' }}></div>
          </div>
        </div>
        ...
        <div className="flex flex-col md:flex-row gap-4 md:gap-6">
          ...
          <div className="hidden md:flex md:flex-col w-full md:w-80 lg:w-96 bg-white p-6 rounded-lg shadow-sm">
            ...
            <ul className="space-y-3 mb-8">
              {["Free 48-hour cancellation policy", "Insurance included in price", "Professional, vetted movers"].map((feature) => (
                <li key={feature} className="flex items-center gap-3">
                  <svg className="w-5 h-5 flex-shrink-0" style={primaryTextStyle} fill="currentColor" viewBox="0 0 20 20">
                  ...
                  <div className="mb-2 h-14 flex items-center justify-center">
                    <div className="relative">
                      <svg
                        ...
                        style={selectedService === service.id ? primaryTextStyle : { color: '#9ca3af' }}
                        fill="currentColor"
                        viewBox="0 0 24 24"
                      >
      ...
      <MobileBottomSheet
        peekContent={
          <div className="flex items-center gap-3 text-sm">
            ...
            <span className="ml-auto" style={primaryTextStyle}>View Details</span>
          </div>
        }
        title="Quote Summary"
      >
        <div className="space-y-4">
          ...
          <div className="space-y-2">
            ...
            <ul className="space-y-2 text-sm text-gray-600">
              {["Free 48-hour cancellation", "Insurance included", "Professional movers"].map((feature) => (
                <li key={feature} className="flex items-center gap-2">
                  <svg className="w-4 h-4" style={primaryTextStyle} fill="currentColor" viewBox="0 0 20 20">
                    <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />
                  </svg>
                  {feature}
                </li>
